...
export class Convert {
    public static toOrder(json: string): Order[] {
        return cast(JSON.parse(json), a(r("Order")));
    }

    public static orderToJson(value: Order[]): string {
        return JSON.stringify(uncast(value, a(r("Order"))), null, 2);
    }
}
...
const typeMap: any = {
    "Order": o([
        ...
        { json: "paymentMethodType", js: "paymentMethodType", typ: "" },
        ...
        { json: "paidAt", js: "paidAt", typ: Date },
